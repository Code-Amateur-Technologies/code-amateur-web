  ...
  return (
    <section className="py-8 px-4 md:p-20 grid">
      ...
      <div className="overflow-hidden">
        <div
          className="mt-12 flex gap-10 overflow-x-auto no-scrollbar scroll-smooth"
          ref={serviceRef}
        ...
        >
          {servicesList.map((service) => (
            <div
              key={service.id}
              className="flex-[0_0_90%] md:flex-[0_0_47%] xl:flex-[0_0_28%]"
            >
        ...
        <div className="mt-10 flex justify-around sm:justify-start">
          <button
            className="light-button mr-5 border disabled:opacity-50"
          ...
          <button
            className="light-button border disabled:opacity-50"
